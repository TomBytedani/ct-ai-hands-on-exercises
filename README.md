# CT-AI hands-on exercises

This repository contains guided learning environments created while studying for the ISTQB Certified Tester AI Testing (CT-AI v2.0) certification. The labs use a **predict → act → observe → explain** loop: the objective is to connect each operation to its role in the machine-learning or testing workflow, not merely to make code run.

The exercises are personal study work and are not official ISTQB training material.
...
Only hands-on exercise material belongs here. The certification syllabus, official sample examination, personal vault notes, and unrelated study files are deliberately kept outside this repository.
